...
const en = {
  ...
  "pro.nav.profile": "Profile",
  // Profile tab: plain words on the big picture-buttons, not feature names.
  "pro.profile.jobs": "Jobs",
  "pro.profile.rating": "Rating",
  "pro.profile.money": "My money",
  "pro.profile.upcoming": "Coming up",
  "pro.profile.getReviews": "Get reviews",
  "pro.profile.inviteBuddy": "Invite a buddy",
  ...
  "hi.addAppliancesSub": "Warranty tracking starts with a model number.",
...
const es: Partial<Record<TKey, string>> = {
  ...
  "pro.nav.profile": "Perfil",
  "pro.profile.jobs": "Trabajos",
  "pro.profile.rating": "Estrellas",
  "pro.profile.money": "Mi dinero",
  "pro.profile.upcoming": "Próximos",
  "pro.profile.getReviews": "Consigue reseñas",
  "pro.profile.inviteBuddy": "Invita a un colega",
  ...
  "hi.addAppliancesSub": "El seguimiento de garantías empieza con un número de modelo.",
...
const ru: Partial<Record<TKey, string>> = {
  ...
  "pro.nav.profile": "Профиль",
  "pro.profile.jobs": "Работы",
  "pro.profile.rating": "Рейтинг",
  "pro.profile.money": "Мои деньги",
  "pro.profile.upcoming": "Скоро",
  "pro.profile.getReviews": "Собрать отзывы",
  "pro.profile.inviteBuddy": "Пригласить друга",
  ...
  "hi.addAppliancesSub": "Отслеживание гарантии начинается с номера модели.",
...
const uk: Partial<Record<TKey, string>> = {
  ...
  "pro.nav.profile": "Профіль",
  "pro.profile.jobs": "Роботи",
  "pro.profile.rating": "Рейтинг",
  "pro.profile.money": "Мої гроші",
  "pro.profile.upcoming": "Незабаром",
  "pro.profile.getReviews": "Збирати відгуки",
  "pro.profile.inviteBuddy": "Запросити друга",
  ...
  "hi.addAppliancesSub": "Відстеження гарантії починається з номера моделі.",
