      ...
      <DialogContent className="sm:max-w-md">
        {submitted ? (
          <div className="py-4 text-center">
            <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-full bg-indigobg text-indigodark">
            ...
            <div className="mt-6">
              <Btn variant="indigo" onClick={() => handleClose(false)} className="w-full">
                Close
              </Btn>
            </div>
          </div>
